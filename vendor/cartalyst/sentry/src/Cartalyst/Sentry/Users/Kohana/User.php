...
class User extends \ORM implements UserInterface {
	...
	public function rules()
	{
		return array (
		    'username' => array (
				array ('not_empty'),
				array ('not_empty'),
				array (array ($this, 'unique_username_key_exists'), array (':value', 'username'))
			),
			'email' => array (
				array ('not_empty'),
				array ('email'),
	...
	public function unique_username_key_exists($value, $field = NULL)
	{
		...
		{
			// Automatically determine field by looking at the value
			$field = 'username';//$this->unique_key($value);
		}
