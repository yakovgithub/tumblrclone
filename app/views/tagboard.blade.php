            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="{{URL::route('publicblog', array('username'=>$user_data->username,'name' => $blog->name))}}"> {{json_decode($post->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->regularPost->content)->content}}</div>
                    <div class="tags">
...
<!--          </div >-->
    ...
    <div class="feed clearfix" >
      ...
      <div class="news panel" >
        ...
        <div class="post_content" >
          <div class="post_info" >
            <a href="{{URL::route('publicblog', array('username'=>$user_data->username,'name' => $post->blog->name))}}" > {{json_decode($post->blog->config)->title}} </a >
          </div >
          <div class="quote" > "{{json_decode($post->regularPost->content)->content}}"</div >
          <div class="source" > {{json_decode($post->regularPost->content)->source}}</div >
          <div class="tags">
  ...
  @elseif($post->type == 'reblogged')
    ...
    <div class="feed clearfix" >
      ...
      <div class="news panel" >
        <div class="post_content" >
          <div class="post_info" >
            <a href="{{URL::route('publicblog', array('username'=>$user_data->username,'name' => $blog->name))}}" > {{json_decode($blog->config)->title}} </a > <i class="glyphicon glyphicon-retweet"></i> <a href="{{URL::route('publicblog', array('username'=>$retwet_user_data->username,'name' => $post->rebloggedPost->originalPost->blog->name))}}"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
          </div >
            ...
            <div class="modal-content reblog clearfix">
              ...
              <input type="hidden" name="originalpostid" value="{{$post->rebloggedPost->originalPost->id}}" />
                <div class="quoted news panel">
                  <div class="post_content">
                    <div class="post_info">
                      <a href="{{URL::route('publicblog', array('username'=>$user_data->username,'name' => $post->rebloggedPost->originalPost->blog->name))}}"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
                    </div>
                    <div class="post_title">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->title}}</div>
                    <div class="post_desc">{{json_decode($post->rebloggedPost->originalPost->regularPost->content)->content}}</div>
                    <div class="tags">
...
<!--          </div >-->
        ...
        <div class="post_content" >
          <div class="post_info" >
            <a href="{{URL::route('publicblog', array('username'=>$user_data->username,'name' => $post->rebloggedPost->originalPost->blog->name))}}" > {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a > <i class="glyphicon glyphicon-retweet"></i> <a href="{{URL::route('publicblog', array('username'=>$retwet_user_data->username,'name' => $post->rebloggedPost->originalPost->blog->name))}}"> {{json_decode($post->rebloggedPost->originalPost->blog->config)->title}} </a>
          </div >
          @foreach(json_decode($post->rebloggedPost->originalPost->regularPost->content)->files as $file)
            <img src="{{asset($file)}}" >
          @endforeach
...
<aside class="sidebar" >
  <div class="btn-group" >
    <a type="button" class="switch dropdown-toggle" >
      <span class="name" >Posts tagged #{{$tagname}} </span >
    </a >
  </div >
</aside >
</section >
